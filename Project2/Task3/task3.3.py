...
# -*- coding: utf-8 -*-
"""
Created on Sat Nov  3 17:32:42 2018
...
def Calculate(arr_mean1, arr_mean2, arr_mean3):
    ...
    for point in temp3:
        ...
        plt.savefig('/Users/stutishukla/Downloads/task3_images/task3_iter2_a.jpg', transparent=True, bbox_inches='tight')
...
mean1, mean2, mean3= Calculate(mean1, mean2, mean3) 
print(mean1) 
print(mean2)
print(mean3)
plt.scatter(mean1[0], mean1[1],color='red', marker='o')
plt.scatter(mean2[0], mean2[1], color='blue', marker='o')
plt.scatter(mean3[0], mean3[1], color='green', marker='o')
plt.savefig('/Users/stutishukla/Downloads/task3_images/task3_iter2_b.jpg', transparent=True, bbox_inches='tight')    

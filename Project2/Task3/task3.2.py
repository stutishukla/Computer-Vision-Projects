...
def Calculate(arr_mean1, arr_mean2, arr_mean3):
    ...
    for i in range(Xh):
        ...
        for j in range(Xw):
            temp.append(X[i][j])
        #calculateEuclideanDistance(temp,temp1,temp2,temp3)
...
plt.savefig('/Users/stutishukla/Downloads/task3_images/task3_iter1_b.jpg', transparent=True, bbox_inches='tight') 
